...
export function helpText(): string {
  ...
  return [
    ...
    "  pgx-cli config show --profile <name>",
    ...
    "  sync doctor",
    "  pgx-cli dev status",
    "  pgx-cli dev check diff",
    "  pgx-cli dev format diff",
    "  pgx-cli dev lint file <path>",
    "  pgx-cli dev lint files <paths...>",
    "  pgx-cli dev lint diff",
    "  pgx-cli dev test unit <suite>",
    ...
    "  pgx-cli logs errors [--lines N]",
    "  pgx-cli logs docker [--lines N]",
    "  pgx-cli logs file <path> [--lines N]",
    "  pgx-cli logs inspect <errors|docker|latest|file <path>> [--tail N]",
    "  pgx-cli rg [--source] [--lines N] [--glob G] <pattern> [path...]",
    "  pgx-cli ir inspect latest [--head N|--tail N|--pattern P]",
    "  pgx-cli ir inspect <path> [--head N|--tail N|--pattern P]",
    "  pgx-cli codex-policy check -- <cmd...>",
    "  pgx-cli codex-policy rules",
    "  pgx-cli agent evidence init [--contract agent-hardening | --claim id:text ...] [--file <path>]",
    ...
    "  pgx-cli agent evidence check [--contract agent-hardening|--require-required-claims] [--file <path>]",
