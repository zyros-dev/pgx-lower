...
class Database {
   ...
   void createTable(pgx_lower::compiler::runtime::VarLen32 name, pgx_lower::compiler::runtime::VarLen32 meta);
   void appendTable(pgx_lower::compiler::runtime::VarLen32 tableName, ArrowTable* newRows);

   virtual void setPersistMode(bool persist);
   void setPersist(bool persist);
   void copyFromIntoTable(pgx_lower::compiler::runtime::VarLen32 tableName,pgx_lower::compiler::runtime::VarLen32 fileName,pgx_lower::compiler::runtime::VarLen32 delimiter,pgx_lower::compiler::runtime::VarLen32 escape);
