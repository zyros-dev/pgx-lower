#ifndef PGX_LOWER_UTILITY_SERIALIZATION_H
#define PGX_LOWER_UTILITY_SERIALIZATION_H
#include <cstddef>
#include <fstream>
#include <memory>
#include <optional>
...
#include <vector>
namespace pgx_lower::compiler::utility {
struct ByteWriter {
...
} //end namespace pgx_lower::compiler::utility
#endif //PGX_LOWER_UTILITY_SERIALIZATION_H
