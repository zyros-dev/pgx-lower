...
/* <<pgx-lower-config>>: auto_should_route_to=lower id=pgx_26_before_check_types_001 */
SELECT bool_col,
...
/* <<pgx-lower-config>>: auto_should_route_to=lower id=pgx_26_before_check_types_002 */
...
/* <<pgx-lower-config>>: auto_should_route_to=lower id=pgx_26_before_check_types_003 */
...
/* <<pgx-lower-config>>: auto_should_route_to=lower id=pgx_26_before_check_types_004 */
...
/* <<pgx-lower-config>>: auto_should_route_to=lower id=pgx_26_before_check_types_005 */
...
/* <<pgx-lower-config>>: auto_should_route_to=fallback id=pgx_26_before_check_types_006 */
SELECT string_col,
...
/* <<pgx-lower-config>>: auto_should_route_to=fallback id=pgx_26_before_check_types_007 */
SELECT char_col,
...
/* <<pgx-lower-config>>: auto_should_route_to=lower id=pgx_26_before_check_types_008 */
SELECT decimal_col,
       numeric_col,
...
/* <<pgx-lower-config>>: auto_should_route_to=lower id=pgx_26_before_check_types_009 */
...
/* <<pgx-lower-config>>: auto_should_route_to=lower id=pgx_26_before_check_types_010 */
SELECT date_col,
...
/* <<pgx-lower-config>>: auto_should_route_to=lower id=pgx_26_before_check_types_011 */
SELECT MIN(date_col) AS earliest_date,
       MAX(date_col) AS latest_date,
       COUNT(date_col) AS unique_dates
FROM type_test_table;

/* <<pgx-lower-config>>: auto_should_route_to=lower id=pgx_26_before_check_types_012 */
...
/* <<pgx-lower-config>>: auto_should_route_to=lower id=pgx_26_before_check_types_013 */
...
/* <<pgx-lower-config>>: auto_should_route_to=lower id=pgx_26_before_check_types_016 */
