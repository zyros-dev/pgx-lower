...
/* <<pgx-lower-config>>: auto_should_route_to=lower id=pgx_36_tpch_minimal_001 */
SELECT o_id, o_date, o_amount
FROM simple_orders
WHERE o_date <= date '1994-07-01' - interval '90' day
ORDER BY o_id;

/* <<pgx-lower-config>>: auto_should_route_to=lower id=pgx_36_tpch_minimal_002 */
SELECT o_id, o_date
FROM simple_orders
WHERE o_date >= date '1994-01-01' AND o_date < date '1995-01-01'
ORDER BY o_id;

/* <<pgx-lower-config>>: auto_should_route_to=lower id=pgx_36_tpch_minimal_003 */
...
/* <<pgx-lower-config>>: auto_should_route_to=lower id=pgx_36_tpch_minimal_004 */
SELECT o_id, o_date
...
/* <<pgx-lower-config>>: auto_should_route_to=lower id=pgx_36_tpch_minimal_005 */
...
/* <<pgx-lower-config>>: auto_should_route_to=lower id=pgx_36_tpch_minimal_006 */
