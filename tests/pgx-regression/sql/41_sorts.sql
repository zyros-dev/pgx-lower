...
/* <<pgx-lower-config>>: auto_should_route_to=fallback id=pgx_41_sorts_005 */
SELECT country_name
FROM (
...
/* <<pgx-lower-config>>: auto_should_route_to=lower id=pgx_41_sorts_008 */
...
/* <<pgx-lower-config>>: auto_should_route_to=fallback id=pgx_41_sorts_017 */
SELECT
    CASE
...
/* <<pgx-lower-config>>: auto_should_route_to=fallback id=pgx_41_sorts_020 */
SELECT r.region_name,
...
/* <<pgx-lower-config>>: auto_should_route_to=fallback id=pgx_41_sorts_021 */
