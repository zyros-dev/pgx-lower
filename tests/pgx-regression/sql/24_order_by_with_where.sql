...
/* <<pgx-lower-config>>: auto_should_route_to=lower id=pgx_24_order_by_with_where_001 */
SELECT name, salary
...
WHERE years > 2
  AND department = 'IT'
ORDER BY years;
/* <<pgx-lower-config>>: auto_should_route_to=lower id=pgx_24_order_by_with_where_004 */
...
/* <<pgx-lower-config>>: auto_should_route_to=fallback id=pgx_24_order_by_with_where_006 */
SELECT name, department, age
FROM test_order_where
WHERE department IN ('IT', 'Sales')
ORDER BY department, age;
/* <<pgx-lower-config>>: auto_should_route_to=lower id=pgx_24_order_by_with_where_007 */
