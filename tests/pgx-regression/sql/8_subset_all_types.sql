...
/* <<pgx-lower-config>>: auto_should_route_to=lower id=pgx_8_subset_all_types_001 */
SELECT id, integer_col, big_int
FROM all_types_test;

/* <<pgx-lower-config>>: auto_should_route_to=lower id=pgx_8_subset_all_types_002 */
SELECT id, boolean_col, text_col, varchar_col
FROM all_types_test;

/* <<pgx-lower-config>>: auto_should_route_to=lower id=pgx_8_subset_all_types_003 */
