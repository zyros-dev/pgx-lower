...
auto PostgreSQLASTTranslator::Impl::translate_arithmetic_op(const QueryCtxT& ctx, const OpExpr* op_expr,
    ...
    const bool is_date_interval_pair = (mlir::isa<mlir::db::DateType, mlir::db::PgDateType>(get_base_type(lhs.getType()))
                                       ...
                                       || (mlir::isa<mlir::db::IntervalType, mlir::db::PgIntervalType>(
                                           ...
                                           && mlir::isa<mlir::db::DateType, mlir::db::PgDateType>(
                                               get_base_type(rhs.getType())));
    const bool is_date_int4_pair = (mlir::isa<mlir::db::DateType, mlir::db::PgDateType>(get_base_type(lhs.getType()))
                                    && mlir::isa<mlir::db::PgInt4Type>(get_base_type(rhs.getType())))
                                   || (mlir::isa<mlir::db::PgInt4Type>(get_base_type(lhs.getType()))
                                       && mlir::isa<mlir::db::DateType, mlir::db::PgDateType>(
                                           get_base_type(rhs.getType())));
    ...
    auto [convertedLhs, convertedRhs] = (is_date_interval_pair || is_date_int4_pair)
