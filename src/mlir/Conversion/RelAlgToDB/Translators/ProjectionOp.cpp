...
std::unique_ptr<pgx::mlir::relalg::Translator> pgx::mlir::relalg::createProjectionTranslator(::mlir::Operation* op) {
   auto projectionOp = ::mlir::cast<pgx::mlir::relalg::ProjectionOp>(op);
