...
class SimpleInnerJoinImpl : public mlir::relalg::JoinImpl {
   public:
   SimpleInnerJoinImpl(mlir::relalg::InnerJoinOp crossProductOp) : mlir::relalg::JoinImpl(crossProductOp, crossProductOp.getLeft(), crossProductOp.getRight()) {}
   SimpleInnerJoinImpl(mlir::relalg::CrossProductOp crossProductOp) : mlir::relalg::JoinImpl(crossProductOp, crossProductOp.getLeft(), crossProductOp.getRight()) {}
...
class CollectionJoinImpl : public mlir::relalg::JoinImpl {
   ...
   public:
   CollectionJoinImpl(mlir::relalg::CollectionJoinOp collectionJoinOp) : mlir::relalg::JoinImpl(collectionJoinOp, collectionJoinOp.getRight(), collectionJoinOp.getLeft()) {
      cols = mlir::relalg::OrderedAttributes::fromRefArr(collectionJoinOp.getCols());
   }
...
class OuterJoinTranslator : public mlir::relalg::JoinImpl {
   public:
   OuterJoinTranslator(mlir::relalg::OuterJoinOp innerJoinOp) : mlir::relalg::JoinImpl(innerJoinOp, innerJoinOp.getRight(), innerJoinOp.getLeft()) {
      this->stopOnFlag = false;
   }
   OuterJoinTranslator(mlir::relalg::SingleJoinOp innerJoinOp) : mlir::relalg::JoinImpl(innerJoinOp, innerJoinOp.getRight(), innerJoinOp.getLeft()) {
      this->stopOnFlag = false;
   }
   virtual void handleLookup(::mlir::Value matched, ::mlir::Value /*marker*/, mlir::relalg::TranslatorContext& context, ::mlir::OpBuilder& builder) override {
...
class ReversedOuterJoinImpl : public mlir::relalg::JoinImpl {
   public:
   ReversedOuterJoinImpl(mlir::relalg::OuterJoinOp innerJoinOp) : mlir::relalg::JoinImpl(innerJoinOp, innerJoinOp.getLeft(), innerJoinOp.getRight(), true) {
   }
   ...
   virtual void handleLookup(::mlir::Value matched, ::mlir::Value markerPtr, mlir::relalg::TranslatorContext& context, ::mlir::OpBuilder& builder) override {
      translator->handlePotentialMatch(builder, context, matched, [&](::mlir::OpBuilder& builder, mlir::relalg::TranslatorContext& context, mlir::relalg::TranslatorContext::AttributeResolverScope& scope) {
         auto const1 = builder.create<mlir::arith::ConstantOp>(loc, builder.getI64Type(), builder.getI64IntegerAttr(1));
         builder.create<mlir::memref::AtomicRMWOp>(loc, builder.getI64Type(), mlir::arith::AtomicRMWKind::assign, const1, markerPtr, ::mlir::ValueRange{});
         translator->handleMapping(builder, context, scope);
      });
   }
...
class SemiJoinImpl : public mlir::relalg::JoinImpl {
   ...
   public:
   SemiJoinImpl(mlir::relalg::SemiJoinOp innerJoinOp) : mlir::relalg::JoinImpl(innerJoinOp, innerJoinOp.getRight(), innerJoinOp.getLeft()) {
   }
   SemiJoinImpl(mlir::relalg::AntiSemiJoinOp innerJoinOp) : mlir::relalg::JoinImpl(innerJoinOp, innerJoinOp.getRight(), innerJoinOp.getLeft()) {
      doAnti = true;
   }
   virtual void handleLookup(::mlir::Value matched, ::mlir::Value /*marker*/, mlir::relalg::TranslatorContext& context, ::mlir::OpBuilder& builder) override {
...
class ReversedSemiJoinImpl : public mlir::relalg::JoinImpl {
   public:
   ReversedSemiJoinImpl(mlir::relalg::SemiJoinOp innerJoinOp) : mlir::relalg::JoinImpl(innerJoinOp, innerJoinOp.getLeft(), innerJoinOp.getRight(), true) {
   }
...
class MarkJoinImpl : public mlir::relalg::JoinImpl {
   public:
   MarkJoinImpl(mlir::relalg::MarkJoinOp innerJoinOp) : mlir::relalg::JoinImpl(innerJoinOp, innerJoinOp.getRight(), innerJoinOp.getLeft()) {
   }
