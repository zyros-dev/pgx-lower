...
class SimpleInnerJoinImpl : public ::mlir::relalg::JoinImpl {
   public:
   SimpleInnerJoinImpl(pgx::mlir::relalg::InnerJoinOp crossProductOp) : ::mlir::relalg::JoinImpl(crossProductOp, crossProductOp.left(), crossProductOp.right()) {}
   SimpleInnerJoinImpl(pgx::mlir::relalg::CrossProductOp crossProductOp) : ::mlir::relalg::JoinImpl(crossProductOp, crossProductOp.left(), crossProductOp.right()) {}

   virtual void handleLookup(::mlir::Value matched, ::mlir::Value /*marker*/,TranslatorContext& context, ::mlir::OpBuilder& builder) override {
      translator->handlePotentialMatch(builder, context, matched);
   }
   virtual ~SimpleInnerJoinImpl() {}
};
std::shared_ptr<::mlir::relalg::JoinImpl> createCrossProductImpl(pgx::mlir::relalg::CrossProductOp crossProductOp) {
   return std::make_shared<SimpleInnerJoinImpl>(crossProductOp);
}
std::shared_ptr<::mlir::relalg::JoinImpl> createInnerJoinImpl(pgx::mlir::relalg::InnerJoinOp joinOp) {
   return std::make_shared<SimpleInnerJoinImpl>(joinOp);
}

class CollectionJoinImpl : public ::mlir::relalg::JoinImpl {
  OrderedAttributes cols;
   ::mlir::Value vector;

   public:
   CollectionJoinImpl(pgx::mlir::relalg::CollectionJoinOp collectionJoinOp) : ::mlir::relalg::JoinImpl(collectionJoinOp, collectionJoinOp.right(), collectionJoinOp.left()) {
      cols =OrderedAttributes::fromRefArr(collectionJoinOp.getCols());
   }
...
std::shared_ptr<::mlir::relalg::JoinImpl> createCollectionJoinImpl(pgx::mlir::relalg::CollectionJoinOp joinOp) {
   return std::make_shared<CollectionJoinImpl>(joinOp);
}

class OuterJoinTranslator : public ::mlir::relalg::JoinImpl {
   public:
   OuterJoinTranslator(pgx::mlir::relalg::OuterJoinOp innerJoinOp) : ::mlir::relalg::JoinImpl(innerJoinOp, innerJoinOp.right(), innerJoinOp.left()) {
      this->stopOnFlag = false;
   }
   OuterJoinTranslator(pgx::mlir::relalg::SingleJoinOp innerJoinOp) : ::mlir::relalg::JoinImpl(innerJoinOp, innerJoinOp.right(), innerJoinOp.left()) {
      this->stopOnFlag = false;
   }
   virtual void handleLookup(::mlir::Value matched, ::mlir::Value /*marker*/,TranslatorContext& context, ::mlir::OpBuilder& builder) override {
      translator->handlePotentialMatch(builder, context, matched, [&](::mlir::OpBuilder& builder,TranslatorContext& context,TranslatorContext::AttributeResolverScope& scope) {
   ...
   void afterLookup(pgx::mlir::relalg::TranslatorContext& context, ::mlir::OpBuilder& builder) override {
      ...
      translator->handlePotentialMatch(builder, context, noMatchFound, [&](::mlir::OpBuilder& builder,TranslatorContext& context,TranslatorContext::AttributeResolverScope& scope) {
...
class ReversedOuterJoinImpl : public ::mlir::relalg::JoinImpl {
   public:
   ReversedOuterJoinImpl(pgx::mlir::relalg::OuterJoinOp innerJoinOp) : ::mlir::relalg::JoinImpl(innerJoinOp, innerJoinOp.left(), innerJoinOp.right(), true) {
   }

   virtual void handleLookup(::mlir::Value matched, ::mlir::Value markerPtr,TranslatorContext& context, ::mlir::OpBuilder& builder) override {
      translator->handlePotentialMatch(builder, context, matched, [&](::mlir::OpBuilder& builder,TranslatorContext& context,TranslatorContext::AttributeResolverScope& scope) {
   ...
   void handleScanned(::mlir::Value marker,TranslatorContext& context, ::mlir::OpBuilder& builder) override {
      auto scope = context.createScope();
      ...
      translator->handlePotentialMatch(builder, context, isZero, [&](::mlir::OpBuilder& builder,TranslatorContext& context,TranslatorContext::AttributeResolverScope& scope) {
         translator->handleMappingNull(builder, context, scope);
      });
   }
...
std::shared_ptr<::mlir::relalg::JoinImpl> createOuterJoinImpl(pgx::mlir::relalg::OuterJoinOp joinOp, bool reversed) {
...
class SemiJoinImpl : public ::mlir::relalg::JoinImpl {
   ...
   public:
   SemiJoinImpl(pgx::mlir::relalg::SemiJoinOp innerJoinOp) : ::mlir::relalg::JoinImpl(innerJoinOp, innerJoinOp.right(), innerJoinOp.left()) {
   }
   SemiJoinImpl(pgx::mlir::relalg::AntiSemiJoinOp innerJoinOp) : ::mlir::relalg::JoinImpl(innerJoinOp, innerJoinOp.right(), innerJoinOp.left()) {
      doAnti = true;
   }
   virtual void handleLookup(::mlir::Value matched, ::mlir::Value /*marker*/,TranslatorContext& context, ::mlir::OpBuilder& builder) override {
...
class ReversedSemiJoinImpl : public ::mlir::relalg::JoinImpl {
   public:
   ReversedSemiJoinImpl(pgx::mlir::relalg::SemiJoinOp innerJoinOp) : ::mlir::relalg::JoinImpl(innerJoinOp, innerJoinOp.left(), innerJoinOp.right(), true) {
   }
...
std::shared_ptr<::mlir::relalg::JoinImpl> createSemiJoinImpl(pgx::mlir::relalg::SemiJoinOp joinOp, bool reversed) {
...
class ReversedAntiSemiJoinImpl : public ::mlir::relalg::JoinImpl {
   public:
   ReversedAntiSemiJoinImpl(pgx::mlir::relalg::AntiSemiJoinOp innerJoinOp) : ::mlir::relalg::JoinImpl(innerJoinOp, innerJoinOp.left(), innerJoinOp.right(), true) {}
...
std::shared_ptr<::mlir::relalg::JoinImpl> createAntiSemiJoinImpl(pgx::mlir::relalg::AntiSemiJoinOp joinOp, bool reversed) {
...
class ConstantSingleJoinTranslator : publicTranslator {
  SingleJoinOp joinOp;
   std::vector<constColumn*> cols;
   std::vector<constColumn*> origAttrs;
   std::vector<mlir::Type> types;
   ::mlir::Value singleValPtr;

   public:
   ConstantSingleJoinTranslator(pgx::mlir::relalg::SingleJoinOp singleJoinOp) :Translator(singleJoinOp), joinOp(singleJoinOp) {
   }
   virtual void setInfo(pgx::mlir::relalg::Translator* consumer, constColumnSet& requiredAttributes) override {
   ...
   virtualColumnSet getAvailableColumns() override {
...
std::shared_ptr<::mlir::relalg::JoinImpl> createSingleJoinImpl(pgx::mlir::relalg::SingleJoinOp joinOp) {
   return std::make_shared<OuterJoinTranslator>(joinOp);
}
std::unique_ptr<pgx::mlir::relalg::Translator> createConstSingleJoinTranslator(pgx::mlir::relalg::SingleJoinOp op) {
   auto joinOp = ::mlir::cast<pgx::mlir::relalg::ConstantSingleJoinOp>(op);
   return std::make_unique<ConstantSingleJoinTranslator>(joinOp);
}

class MarkJoinImpl : publicJoinImpl {
   public:
   MarkJoinImpl(pgx::mlir::relalg::MarkJoinOp innerJoinOp) :JoinImpl(innerJoinOp, innerJoinOp.getRight(), innerJoinOp.getLeft()) {
   }
...
std::shared_ptr<::mlir::relalg::JoinImpl> createMarkJoinImpl(pgx::mlir::relalg::MarkJoinOp joinOp) {
   return std::make_shared<MarkJoinImpl>(joinOp);
}
std::unique_ptr<Translator> Translator::createJoinTranslator(::mlir::Operation* joinOp) {
   bool reversed = false;
   bool hash = false;
   bool constant = false;
   ...
   if (constant) {
      return createConstSingleJoinTranslator(::mlir::cast<pgx::mlir::relalg::SingleJoinOp>(joinOp));
   }
   auto joinImpl = ::llvm::TypeSwitch<::mlir::Operation*, std::shared_ptr<::mlir::relalg::JoinImpl>>(joinOp)
                      .Case<pgx::mlir::relalg::CrossProductOp>([&](auto x) { return createCrossProductImpl(x); })
                      .Case<pgx::mlir::relalg::InnerJoinOp>([&](auto x) { return createInnerJoinImpl(x); })
                      .Case<pgx::mlir::relalg::SemiJoinOp>([&](auto x) { return createSemiJoinImpl(x, reversed); })
                      .Case<pgx::mlir::relalg::AntiSemiJoinOp>([&](auto x) { return createAntiSemiJoinImpl(x, reversed); })
                      .Case<pgx::mlir::relalg::OuterJoinOp>([&](auto x) { return createOuterJoinImpl(x, reversed); })
                      .Case<pgx::mlir::relalg::SingleJoinOp>([&](auto x) { return createSingleJoinImpl(x); })
                      .Case<pgx::mlir::relalg::MarkJoinOp>([&](auto x) { return createMarkJoinImpl(x); })
                      .Case<pgx::mlir::relalg::CollectionJoinOp>([&](auto x) { return createCollectionJoinImpl(x); })
                      .Default([](auto x) { assert(false&&"should not happen"); return std::shared_ptr<::mlir::relalg::JoinImpl>(); });
