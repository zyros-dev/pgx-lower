...
class SortTranslator : public mlir::relalg::Translator {
   ...
   ::mlir::Value createSortPredicate(::mlir::OpBuilder& builder, std::vector<std::pair<::mlir::Value, ::mlir::Value>> sortCriteria, ::mlir::Value trueVal, ::mlir::Value falseVal, size_t pos) {
      if (pos < sortCriteria.size()) {
         ...
         auto ifOp = builder.create<mlir::scf::IfOp>(
            sortOp->getLoc(), lt, [&](::mlir::OpBuilder& builder, ::mlir::Location loc) { builder.create<mlir::scf::YieldOp>(loc, trueVal); }, [&](::mlir::OpBuilder& builder, ::mlir::Location loc) {
               ...
               auto ifOp2 = builder.create<mlir::scf::IfOp>(loc, eq,[&](::mlir::OpBuilder& builder, ::mlir::Location loc) {
   ...
   virtual void produce(mlir::relalg::TranslatorContext& context, ::mlir::OpBuilder& builder) override {
      ...
      children[0]->produce(context,builder);
      {
         ...
         dbSortOp.getRegion().push_back(block2);
         ::mlir::OpBuilder builder2(dbSortOp.getRegion());
         ...
         for (auto attr : sortOp.getSortspecs()) {
            auto sortspecAttr = cast<mlir::relalg::SortSpecificationAttr>(attr);
