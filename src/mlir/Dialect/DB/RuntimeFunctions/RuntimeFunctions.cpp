...
static ::mlir::Value dumpValuesImpl(::mlir::OpBuilder& rewriter, ::mlir::ValueRange loweredArguments, ::mlir::TypeRange originalArgumentTypes, ::mlir::Type resType, ::mlir::TypeConverter* typeConverter,::mlir::Location loc) {
   ...
   auto nullableType = originalArgumentTypes[0].dyn_cast<mlir::db::NullableType>();
   ...
   } else if (auto decType = baseType.dyn_cast<mlir::db::DecimalType>()) {
   ...
   } else if (auto dateType = baseType.dyn_cast<mlir::db::DateType>()) {
      rt::DumpRuntime::dumpDate(rewriter, loc)({isNull, val});
   } else if (auto timestampType = baseType.dyn_cast<mlir::db::TimestampType>()) {
   ...
   } else if (auto intervalType = baseType.dyn_cast<mlir::db::IntervalType>()) {
   ...
   } else if (auto charType = baseType.dyn_cast<mlir::db::CharType>()) {
