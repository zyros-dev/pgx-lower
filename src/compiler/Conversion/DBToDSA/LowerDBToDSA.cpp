#include "compiler/Conversion/DBToDSA/LowerDBToDSA.h"
#include "compiler/Conversion/DSAToLLVM/LowerDSAToLLVM.h"
// Arrow dialect doesn't exist in pgx-lower
// #include "compiler/Dialect/arrow/ArrowDialect.h"
// #include "compiler/Dialect/arrow/ArrowOps.h"
#include "compiler/Dialect/DB/DBDialect.h"
#include "compiler/Dialect/DB/DBOps.h"
// #include "compiler/Dialect/DB/RuntimeFunctions.h"
// #include "compiler/Dialect/DB/Passes.h"
...
// #include "compiler/Dialect/mlir-support/parsing.h"
// #include "compiler/Dialect/runtime/StringRuntime.h"
   ...
   LogicalResult matchAndRewrite(db::CmpOp cmpOp, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override {
      ...
      switch (cmpOp.getPredicate()) {
         case db::DBCmpPredicate::eq: {
            ...
            // TODO Phase 10: this should be speculated to be **false** to move longer string comparisons out of the hot path
