...
#include "compiler/Dialect/SubOperator/Transforms/ColumnCreationAnalysis.h"
#include "compiler/Dialect/SubOperator/Transforms/ColumnUsageAnalysis.h"
#include "compiler/Dialect/SubOperator/Transforms/Passes.h"
#include "compiler/Dialect/SubOperator/Transforms/StateUsageTransformer.h"
#include "compiler/Dialect/SubOperator/Transforms/SubOpDependencyAnalysis.h"
                        ...
                        for (auto& problematicOp : collisionGroup.ops) {
                           ...
                           if (auto materializeOp = mlir::dyn_cast_or_null<subop::MaterializeOp>(problematicOp.op.getOperation())) {
                              ...
                              if (isX86 && collisionGroup.ops.size() == 1) {
                                 // TODO Phase 12: check if this is actually a sane optimization on x86
